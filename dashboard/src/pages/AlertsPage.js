...
function PriorityBadge({ priority }) {
  ...
  const meta = PRIORITY_META[p] || { label: p || "—", bg: "rgba(107,114,128,0.25)", fg: "#fff", border: "rgba(107,114,128,0.55)" };
    ...
    <div className="content">
      ...
      <div className="card">
        <div className="card-header">
          ...
          <button className="btn btn-secondary" type="button" onClick={() => fetchAlerts().catch((e) => console.error(e))}>
            Refresh
          </button>
        </div>
        ...
        >
          ...
          <div className="card" style={{ padding: 14 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10 }}>
              <div>
                <div style={{ fontSize: 18, fontWeight: 800, color: "#e2e8f0" }}>Details</div>
                <div style={{ marginTop: 4, fontSize: 13, color: "rgba(226,232,240,0.7)" }}>
                  Linked evidence for the selected alert
                </div>
              </div>
            ...
            {selectedId == null ? (
              ...
              <div style={{ marginTop: 14, color: "rgba(226,232,240,0.85)" }}>Loading…</div>
            ) : !details ? (
              <div style={{ color: "rgba(226,232,240,0.65)", marginTop: 14 }}>No details loaded.</div>
            ) : (
              <div style={{ marginTop: 14 }}>
                <div style={{ fontSize: 12, color: "rgba(226,232,240,0.65)" }}>ALERT</div>
                <div style={{ fontWeight: 900, marginTop: 6, color: "#e2e8f0" }}>{details.alert?.title}</div>
                ...
                <div className="alerts-grid" style={{ marginTop: 10, display: "grid", gap: 10 }}>
                  {(details.linked_items || []).map((it, idx) => (
                    ...
                    >
                      <div style={{ display: "flex", justifyContent: "space-between", gap: 12 }}>
                        <div style={{ fontWeight: 900, fontSize: 13, color: "#e2e8f0" }}>{it.log_type}</div>
                  ...
                  {(!details.linked_items || details.linked_items.length === 0) && (
                    <div style={{ color: "rgba(226,232,240,0.65)" }}>No linked items.</div>
                  )}
                </div>
              </div>
            )}
